...
// implement consensus vote result Option B. Set Max Supply to 2000M RAIN and staking to 10%
static const int64_t COIN_YEAR_REWARD_NEW = 10 * CENT;
static const int64_t RAIN_CAP = 2000000000 * COIN;
static const int CONSENSUS_CHANGE_BLOCK = 1612000; // should be around March 10th 2020
