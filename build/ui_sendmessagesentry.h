...
public:
    ...
    void setupUi(QFrame *SendMessagesEntry)
    {
        ...
        SendMessagesEntry->setStyleSheet(QStringLiteral(""));
        ...
        sendTo->setStyleSheet(QStringLiteral(""));
        ...
        addressBookButton->setStyleSheet(QStringLiteral(""));
        QIcon icon;
        ...
        pasteButton->setStyleSheet(QStringLiteral(""));
        QIcon icon1;
        ...
        messageText->setStyleSheet(QStringLiteral(""));
        ...
        addAsLabel->setStyleSheet(QStringLiteral(""));
        ...
        publicKey->setStyleSheet(QStringLiteral(""));
