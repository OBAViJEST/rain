...
public:
    ...
    void setupUi(QDialog *QRCodeDialog)
    {
        ...
        QRCodeDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        outUri->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        btnSaveAs->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
