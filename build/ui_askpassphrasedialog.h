...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        passEdit1->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        passEdit2->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        passEdit3->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
