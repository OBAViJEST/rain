...
public:
    ...
    void setupUi(QDialog *SendMessagesDialog)
    {
        ...
        SendMessagesDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        addressFrom->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        scrollArea->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QStringLiteral("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 828, 291));
        ...
        closeButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon5;
