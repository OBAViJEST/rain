...
public:
    ...
    void setupUi(QDialog *TransactionDescDialog)
    {
        ...
        TransactionDescDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        detailText->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
